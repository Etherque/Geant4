...
//Get Position On T2
  if((stepNum!=1)&&(next_volume_name.contains("Targetbar4"))&&(procName=="Transportation")){ 
    ...
    /*     G4cout << next_volume_name <<"_:"//<< prestep
                 << name << "  "
   ...
   if((angle_z<=2.0*deg)&&(angle_z>=0.0*deg)){
    G4cout   << next_volume_name<<"_0_2:"
             << name << "  " 
             << G4BestUnit(Fdx,"Length") << G4BestUnit(Fdy,"Length") << G4BestUnit(Fdz,"Length")<< G4BestUnit(angle_z,"Angle")<<" "
             << G4BestUnit(KineticE_fd,"Energy")
             << G4endl;
    }
  
   if((angle_z<=4.0*deg)&&(angle_z>=2.0*deg)){
    G4cout   << next_volume_name<<"_2_4:"
             << name << "  "
             << G4BestUnit(Fdx,"Length") << G4BestUnit(Fdy,"Length") << G4BestUnit(Fdz,"Length")<< G4BestUnit(angle_z,"Angle")<<" "
             << G4BestUnit(KineticE_fd,"Energy")
             << G4endl;
    ...
    if((angle_z<=6.0*deg)&&(angle_z>=4.0*deg)){
    G4cout   << next_volume_name<<"_4_6:"
             << name << "  "
             << G4BestUnit(Fdx,"Length") << G4BestUnit(Fdy,"Length") << G4BestUnit(Fdz,"Length")<< G4BestUnit(angle_z,"Angle")<<" "
             << G4BestUnit(KineticE_fd,"Energy")
             << G4endl;
    ...
    if((angle_z<=8.0*deg)&&(angle_z>=6.0*deg)){
    G4cout   << next_volume_name<<"_6_8:"
             << name << "  "
             << G4BestUnit(Fdx,"Length") << G4BestUnit(Fdy,"Length") << G4BestUnit(Fdz,"Length")<< G4BestUnit(angle_z,"Angle")<<" "
             << G4BestUnit(KineticE_fd,"Energy")
             << G4endl;
    ...
    if((angle_z<=10.0*deg)&&(angle_z>=8.0*deg)){
    G4cout   << next_volume_name<<"_8_10:"
             << name << "  "
             << G4BestUnit(Fdx,"Length") << G4BestUnit(Fdy,"Length") << G4BestUnit(Fdz,"Length")<< G4BestUnit(angle_z,"Angle")<<" "
             << G4BestUnit(KineticE_fd,"Energy")
             << G4endl;
     ...
     if((angle_z<=12.0*deg)&&(angle_z>=10.0*deg)){
    G4cout   << next_volume_name<<"_10_12:"
             << name << "  "
             << G4BestUnit(Fdx,"Length") << G4BestUnit(Fdy,"Length") << G4BestUnit(Fdz,"Length")<< G4BestUnit(angle_z,"Angle")<<" "
             << G4BestUnit(KineticE_fd,"Energy")
             << G4endl;
...
if(((abs(pdx)<4.45*cm)||(abs(pdx)>4.60*cm))&&((abs(tdy)<4.45*cm)||((abs(tdy)
>4.60*cm)&&(abs(tdy)<13.5*cm))||(abs(tdy)>13.8*cm))){
